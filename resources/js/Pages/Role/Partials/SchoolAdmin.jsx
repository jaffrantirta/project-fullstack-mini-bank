        ...
        <div>
            ...
            <div className="overflow-x-auto p-5 md:p-10">
                <Table>
                    ...
                    <tbody>
                        {props.school_admins.data.length > 0 ? (
                            props.school_admins.data.map((user, index) => (
                                <Tr key={index}>
            ...
            <Modal show={confirmingDeletion} onClose={closeModal}>
                <form onSubmit={deleteProcess} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        Ketika dihapus, user tidak bisa mendapatkan akses ke
                        admin dan perlu ditambahkan kembali.
                    </p>
