        ...
        <nav {...props} role="navigation" aria-label="Paginator" className={`flex items-center justify-between ${className}`}>
            <div className="flex justify-between flex-1 sm:hidden">
                {!data.prev_page_url ?
                    ...
                    :
                    <a href={data.prev_page_url} className="relative hover:bg-secondary rounded-full inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                        Previous
                    </a>
                }

                {data.next_page_url ?
                    <a href={data.next_page_url} className="relative hover:bg-secondary rounded-full inline-flex items-center px-4 py-2 ml-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                        Next
                    </a>
                    :
